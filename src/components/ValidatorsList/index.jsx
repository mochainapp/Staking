...
const ValidatorsList = () => {
  ...
  console.log('entities', showOnlyOldNodes, showOnlyDelegators, showOnlyStaked)
  const data = useMemo(() => {
    ...
    return sortBy(map(rawData, ({
      ...
      yourStake,
      website,
      isOpen: forDelegation && (formatWeiToNumber(fee) * 100) >= 10,
      oldNode
    })), [({ isOpen }) => !isOpen])
    ...
    () => isMobile
      ? [{
        ...
        },
        {
          ...
          Header: <TableHeader header='Staked amount' tooltipText='The amount of MO staked to each validator.' id='staked' />
        },
        {
          accessor: 'fee',
