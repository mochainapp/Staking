  ...
  return (
    <div className='form'>
      <div className='input__wrapper'>
        <div className={classNames('balance', { 'balance--disabled': !accountAddress || !validator })}>Balance - <span>{formatWei(balanceToShow)} MO</span></div>
        <div className='input'>
          <Field name='amount'>
            {({
              field
